...
const Recharge = () => {
    ...
    const [orderNumber, setOrderNumber] = useState("Pt2024072807531989624491");
    ...
    const Deposithandleclick = () => {
        ...
        const countdownTime = new Date(currentTime.getTime() + 5 * 60 * 1000); // 10 minutes from now
        ...
        if (way === "paytmQR" || way === "UPI-QR" || way === "EWallet") {
            ...
            navigate('/Payment', {
                state: {
                    ...
                    network,
                    walletAddress,
                    countdownTime: countdownTime.getTime() / 1000, // 5 minutes in seconds
                }
            });
        }
            ...
            <div className='flex bg-[#2b3270] flex-col font-sans  text-white rounded-[20px]  p-5 gap-3 m-3  '>
                ...
                {way === "USDT" ? (
                    <>
                        ...
                        <div className='grid grid-cols-3 gap-4 '>
                            <div className='border border-[#374992] rounded-lg items-center flex   mx-2  justify-evenly  cursor-pointer' onClick={() => setAmount(10)} >
                                <span className='text-[gray] font-semibold text-[1.2rem] '><img className='w-[1.2rem]' src={USTD} alt="" /></span>
                        ...
                        <div className=' w-[350px] h-[2.5rem] border rounded-3xl flex items-center justify-evenly px-2 '>
                            ...
                            <input type="text" value={amount} className=' border-l  bg-transparent focus:outline-none outline-none ml-3 pl-3 w-full  border-gray-500 text-white text-[1.1rem]  ' placeholder='Please enter the amount' />
                        ...
                        <div className=' w-[350px] h-[2.5rem] border rounded-3xl flex items-center justify-evenly px-2 '>
                            ...
                            <input disabled type="text" defaultValue={amount * 93.5} className=' border-l  cursor-not-allowed bg-transparent focus:outline-none outline-none ml-3 pl-3 w-full  border-gray-500 text-white text-[1.1rem]  ' placeholder='Please enter the amount' />
                    ...
                    <>
                        ...
                        <div className='grid grid-cols-3 gap-4 '>
                            <div className='border border-[#374992] rounded-lg items-center flex   mx-2  justify-evenly  cursor-pointer' onClick={() => setAmount(10)} >
                                <span className='text-[gray] font-semibold text-[1.2rem] '><img className='w-[1.2rem]' src={TRX} alt="" /></span>
                                <span className='text-[#367ff6] font-semibold text-[1.3rem]'>10</span>
                            </div>
                            <div className='border border-[#374992] rounded-lg items-center flex   mx-2  justify-evenly  cursor-pointer' onClick={() => setAmount(50)} >
                                <span className='text-[gray] font-semibold text-[1.2rem] '><img className='w-[1.2rem]' src={TRX} alt="" /></span>
                        ...
                        <div className=' w-[350px] h-[2.5rem] border rounded-3xl flex items-center justify-evenly px-2 '>
                            <img className='w-[1.8rem]     ' src="https://img.icons8.com/?size=100&id=87785&format=png&color=056FEBBF" alt="" />
                            <input disabled type="text" defaultValue={amount * 10.8} className=' border-l  cursor-not-allowed bg-transparent focus:outline-none outline-none ml-3 pl-3 w-full  border-gray-500 text-white text-[1.1rem]  ' placeholder='Please enter the amount' />
                    ...
                    <>
                        ...
                        <div className=' w-[350px] h-[2.5rem] border rounded-3xl flex items-center justify-evenly px-2 '>
                            <img className='w-[1.8rem]     ' src="https://img.icons8.com/?size=100&id=87785&format=png&color=056FEBBF" alt="" />
                            <input type="text" value={amount} className=' border-l  cursor-not-allowed bg-transparent focus:outline-none outline-none ml-3 pl-3 w-full  border-gray-500 text-white text-[1.1rem]  ' placeholder='Please enter the amount' />
                ...
                <button onClick={Deposithandleclick} disabled={disabled} className={` bg-blue-600 hover:bg-transparent  font-semibold  w-[350px] h-[2.5rem]  ${disabled ? "cursor-pointer" : "cursor-default"}  rounded-3xl border border-transparent  px-2 hover:border hover:border-[#8080809e] transition-all duration-300 `}> Deposit</button>
                ...
                <div className=" m-3 p-4  bg-[#2b3270]      rounded-xl shadow-md space-y-4 ">
                    ...
                    <div className='flex text-gray-400 items-center justify-between text-[0.8rem] gap-2 flex-col'>
                        ...
                        <div className='flex justify-between items-center w-full text-nowrap  '>
                            <p>Order Number</p>
                            <div>
                                <span value={orderNumber}   >Pt2024072807531989624491 </span>
                                <button onClick={() => copyToClipboard(orderNumber)} ><img className='w-[0.9rem] ml-1 mt-1 ' src="https://img.icons8.com/?size=100&id=86206&format=png&color=525C6A99" alt="" /></button>
